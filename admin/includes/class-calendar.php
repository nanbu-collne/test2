...
class Calendar_Data {
	...
	function setCalendarData() {
		...
		$day = 1;	// 当月開始日に設定
		$firstw = wc2_get_week($this->_year, $this->_month, $day);		// 当月開始日の曜日
		$lastday = wc2_get_lastday($this->_year, $this->_month);			// 当月最終日
		$lastw = wc2_get_week($this->_year, $this->_month, $lastday);	// 当月最終日の曜日
