...
if (class_exists('TCPDF', false)) {
    require_once( WC2_PLUGIN_DIR . '/common/includes/pdf/fpdi/fpdi2tcpdf_bridge.php');
}

require_once( WC2_PLUGIN_DIR . '/common/includes/pdf/fpdi/fpdf_tpl.php');
require_once( WC2_PLUGIN_DIR . '/common/includes/pdf/fpdi/fpdi_pdf_parser.php');
