	...
	if( !empty( $array['settlement'] ) ){
		...
		switch( $array['settlement'] ){
			case 'acting_zeus_card':
				...
				$html_howpay .= '
					<tr>
					<th scope="row">'.__('Payment method', 'wc2').'</th>
					<td><input name="offer[howpay]" type="radio" value="1" id="howdiv1"' . (('1' === $howpay) ? ' checked="checked"' : '') . ' /><label for="howdiv1">一括払い</label></td>
					<td><input name="offer[howpay]" type="radio" value="0" id="howdiv2"' . (('0' === $howpay) ? ' checked="checked"' : '') . ' /><label for="howdiv2">分割払い</label></td>
					</tr>
					<tr id="cbrand_zeus">
			...
			case 'acting_zeus_conv':
				...
				<table class="customer_form" id="' . $paymod_id . '_conv">
					<tr>
					<th scope="row">'.__('お支払に利用するコンビニ', 'usces').'</th>
					<td colspan="2">
				...
				$html .= '
					...
					<tr>
					<th scope="row"><span class="required">'. __('*', 'wc2').'</span>'.__('お名前', 'usces').'</th>
